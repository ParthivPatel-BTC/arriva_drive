class Note < ActiveRecord::Base
  ...
  def send_notification_to_participant(tagged_participant, current_participant, host)
    begin
      ArriveDriveMailer.delay.send_notification_to_participant(self, tagged_participant, current_participant, host)
    rescue Exception => e
